...
#his might have failed because href is nested inside the class itemlist. For the next attempt, search on item_list.
# Because "class" is a reserved word in Python, class_ is used instead.
